...
export class PmbsComponent implements OnInit {
  ...
  submitMemberShip() {
    ...
    if (this.addMembershipForm.value.Card_Type == "" || this.addMembershipForm.value.Card_Type == null) {
      finalString += "Please select card type.<br>";
    }
    if (this.addMembershipForm.value.Card_Number == "" || this.addMembershipForm.value.Card_Number == null) {
      finalString += "Please enter card number.<br>";
    }
    if (this.addMembershipForm.value.card_holder_name == "" || this.addMembershipForm.value.card_holder_name == null) {
      finalString += "Please enter card holder name.<br>";
    }
    if (this.addMembershipForm.value.cvv == "" || this.addMembershipForm.value.cvv == null) {
      finalString += "Please enter CVV.<br>";
    }
    if (this.addMembershipForm.value.exp_month == "" || this.addMembershipForm.value.exp_month == null) {
      finalString += "Please select expiration month.<br>";
    }
    if (this.addMembershipForm.value.exp_year == "" || this.addMembershipForm.value.exp_year == null) {
