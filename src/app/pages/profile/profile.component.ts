...
export class ProfileComponent implements OnInit {
  ...
  // @ViewChild('userClaimKeyPdf', { static: false }) userClaimKeyPdf: ElementRef;
  userClaimKeyPdf: ''
  ...
  confirmYesClaimKey() {
   //console.log("result of get allllllllllllllllll country: ");
    if (this.wcx_rewards_tokens != 0) {
      ...
      let userClaimKeytext = `<h3 style="padding-top: 10px; color:#0b3655;font-size: 25px !important;">WeCoOwn Management</h3>
