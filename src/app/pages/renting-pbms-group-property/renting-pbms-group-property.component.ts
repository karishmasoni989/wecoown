...
export class RentingPbmsGroupPropertyComponent implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.createRentingPropertyForm = new FormGroup({
      ...
      // renting_notes: new FormControl(''),
      // price: new FormControl(''),
      // distribution_of_price: new FormControl(''),
      ...
      // security_amount: new FormControl(''),
  ...
  submitRentingPropertyForm() {
    ...
    if (this.createRentingPropertyForm.value.deposit_recevied_from == "") {
      finalString += "Please enter deposit recevied from.<br>";
    }
    if (this.createRentingPropertyForm.value.amount == "") {
      finalString += "Please enter amount.<br>";
    }
    if (this.createRentingPropertyForm.value.current_address == "") {
      finalString += "Please enter current address.<br>";
    }
    if (this.createRentingPropertyForm.value.property_located_at == "") {
      finalString += "Please enter property located at.<br>";
    }
    if (this.createRentingPropertyForm.value.rent_amount == "") {
    ...
    if (this.createRentingPropertyForm.value.late_fee == "") {
      finalString += "Please enter late fee.<br>";
    }
    if (this.createRentingPropertyForm.value.first_month_rent_before_date == "") {
      finalString += "Please select first month rent balance to be paid on or before date.<br>";
    }
    if (this.createRentingPropertyForm.value.security_deposit == "") {
      finalString += "Please enter security deposit.<br>";
    }
    if (this.createRentingPropertyForm.value.property_available_move_date == "") {
