...
export class EditAdComponent implements OnInit {
    ...
    this.UserService.getAdByIDAndName(formData).subscribe(result => {
      ...
      if (result['success'] == true) {
        if (adName == "Banner Ad") {
          ...
          this.endDateBanner = this.getBannerData[0].end_date;
          this.banner_start_date = this.getBannerData[0].start_date;
          ...
          this.poster_start_date = this.getPosterData[0].start_date;
          this.endDatePoster = this.getPosterData[0].end_date;
          ...
          this.sidebar_start_date = this.getSidebarData[0].start_date;
          this.endDateSidebar = this.getSidebarData[0].end_date;
          ...
          this.vendor_start_date = this.getvendorData[0].start_date;
          this.endDateVender = this.getvendorData[0].end_date;
          this.previousVendorDate = this.getvendorData[0].end_date;
  ...
  VendorPageListingSubmit() {
    ...
    if (finalString == '') {
      this.loading = true;
      if (this.endDateVender != this.previousVendorDate) {   
        // alert("tttttttttttt")     
