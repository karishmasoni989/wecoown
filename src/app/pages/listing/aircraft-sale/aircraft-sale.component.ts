...
export class AircraftSaleComponent implements OnInit {
  ...
  submit() {
    ...
    $('.BuyerDanger').show();
    if (finalString == "") {
      // start set country and state value
      // let getCountrySplitName = this.createPostingForm.value.country.split('||');
      // this.createPostingForm.value.country = getCountrySplitName[1];
      // let getStateSplitName = this.createPostingForm.value.state.split('||');
      // this.createPostingForm.value.state = getStateSplitName[2];
      // end set country and state value
